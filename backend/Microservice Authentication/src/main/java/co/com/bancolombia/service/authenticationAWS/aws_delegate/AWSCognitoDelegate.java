...
public class AWSCognitoDelegate {
    ...
    /* Parameters needed to perform SRP Authentication*/
    ...
    private static final String AUTH_USER_KEY = "USERNAME";
    private static final String AUTH_SPR_KEY = "SRP_A";


    private static String POOL_ID;
    private static String CLIENT_POOL_ID;
    ...
    public void signUp(UserParameters userParameters)
        ...
        to register a user */
        userAttribute = new AttributeType()
                .withName("name")
        ...
        SignUpRequest signUpRequest = new SignUpRequest()
                .withClientId(CLIENT_POOL_ID)
                .withUsername(userParameters.getEmail())
                .withPassword(userParameters.getPassword())
    ...
    /**
     * Verify the verification code sent on the user email.
     *
     ...
     */
    public void verifyAccessCode(String username, String code)
            throws AWSCognitoIdentityProviderException {

        ConfirmSignUpRequest confirmSignUpRequest = new ConfirmSignUpRequest();
        confirmSignUpRequest.setUsername(username);
        confirmSignUpRequest.setConfirmationCode(code);
        confirmSignUpRequest.setClientId(CLIENT_POOL_ID);
    ...
    public AuthenticationResultType authenticateUser(String username, String password)
        ...
        authRequest.setClientId(CLIENT_POOL_ID);

        authRequest.addAuthParametersEntry(AUTH_USER_KEY, username);
        authRequest.addAuthParametersEntry(AUTH_SPR_KEY, this.A.toString(16));
        ...
        if (ChallengeNameType.PASSWORD_VERIFIER.toString().equals(authResult.getChallengeName())) {
            ...
            loginResult = cognitoClient.respondToAuthChallenge(challengeRequest);
            return loginResult.getAuthenticationResult();
        }
    ...
    private RespondToAuthChallengeRequest userSrpAuthRequest(InitiateAuthResult challenge,
        ...
        try {
            ...
            mac.init(keySpec);
            mac.update(POOL_ID.split("_", 2)[1].getBytes(StringUtils.UTF8));
        ...
        authChallengeRequest.setClientId(CLIENT_POOL_ID);
    ...
    private byte[] getPasswordAuthenticationKey(String userId,
        ...
        messageDigest.reset();
        messageDigest.update(POOL_ID.split("_", 2)[1].getBytes(StringUtils.UTF8));
    ...
    private void initSRPParameters() {
        do {
